...
namespace MiApi.Repository
{
    public class VentaHandler
    {
        ...
        /*public static bool CreateVenta(List<PostVenta> producto, int IdUsuario)
        {
            bool resultado = false;
            bool cargaVenta = false;
            int idVentaSQL;
            bool cargaProductoVendido = false;
            bool cargaStockProducto = false;
            ...
            using (SqlConnection sqlConnection = new SqlConnection(ConnectionString))
            {
                ...
                string queryLastVenta = "SELECT Id FROM Venta ORDER BY Id DESC";
...

                {
                    ...
                    using (SqlCommand sqlCommand = new SqlCommand(queryLastVenta, sqlConnection))
                    {
                        using (SqlDataReader dataReader = sqlCommand.ExecuteReader())
                        {
                            if (dataReader.HasRows)
                ...
                string queryProductoVendido = "INSERT INTO ProductoVendido (" +
                ...
                parametroStock.SqlDbType = System.Data.SqlDbType.VarChar;
                ...
                parametroIdProducto.SqlDbType = System.Data.SqlDbType.VarChar;
                parametroIdProducto.Value = DateTime.Now;

                SqlParameter parametroIdVenta = new SqlParameter();
                parametroIdVenta.ParameterName = "Comentarios";
                parametroIdVenta.SqlDbType = System.Data.SqlDbType.VarChar;
                parametroIdVenta.Value = idVentaSQL;*/

        /*foreach(Producto p in producto)
        {
            string queryCargaProductoVendido = "INSERT INTO ([Stock], " +
                "[IdProducto], " +
                "[IdVenta] " +
                "VALUES " +
                "@Stock, " +
            ...
            SqlParameter parametroStock = new SqlParameter();
            parametroIdUsuario.ParameterName = "Stock";
            parametroIdUsuario.SqlDbType = System.Data.SqlDbType.VarChar;
            parametroIdUsuario.Value = producto.Stock;
